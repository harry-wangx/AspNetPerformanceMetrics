...
namespace AspNetPerformance
{
    ...
    public class WebApiPerformanceAttribute : ActionFilterAttribute
    {
        ...
        /// </summary>
        /// <param name="actionContext">An ActionExecutedContext with info about the action that is executing</param>
        public override void OnActionExecuting(ActionExecutingContext actionContext)
        {
            ...
            HttpContext.Current.Items.Add(this.GetType().FullName, tracker);
        ...
        public override void OnActionExecuted(ActionExecutedContext actionExecutedContext)
        {
            ...
            PerformanceTracker tracker = HttpContext.Current.Items[key] as PerformanceTracker;
        ...
        /// </summary>
        /// <param name="actionContext">The ActionExecutedContext from the OnActionExecuting() method</param>
        /// <returns></returns>
