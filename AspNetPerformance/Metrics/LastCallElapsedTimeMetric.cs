...
namespace AspNetPerformance.Metrics
{
    ...
    public class LastCallElapsedTimeMetric : PerformanceMetricBase
    {
        ...
        /// </summary>
        public const String COUNTER_NAME = "最后一次请求耗时(毫秒)";
        ...
        /// </summary>
        /// <remarks>
        /// This method converts the milliseconds value to milliseconds, and then sets
        /// the counter "Last Call Elapsed Time" to this value, thereby overwriting whatever
        /// was in the counter previously.
        /// </remarks>
        /// <param name="milliseconds">A long of the ticks it took the action to complete</param>
        public override void OnActionComplete(long milliseconds, bool exceptionThrown)
        {
            ...
            Metric.Context(this.actionInfo.ActionType).Gauge(counterName, () => milliseconds, Unit.Custom("毫秒"));
        }
