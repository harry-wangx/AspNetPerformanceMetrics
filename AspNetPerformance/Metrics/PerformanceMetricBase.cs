...
namespace AspNetPerformance.Metrics
{
    ...
    public abstract class PerformanceMetricBase : IDisposable
    {
        ...
        public virtual void OnActionComplete(long milliseconds, bool exceptionThrown)
        {
        ...
        ///// </remarks>
        ///// <param name="milliseconds">A long of the number of ticks</param>
        ///// <returns>A long of the corresponding value in milliseconds</returns>
        //protected long ConvertTicksToMilliseconds(long milliseconds)
        //{
        //    decimal d =  Math.Round(1000 * (decimal)milliseconds / Stopwatch.Frequency);
